...
if($_POST['action']=='additem'){
    ...
    function cartoonImage($pattern, $numlevels, $edgemethod, $edgeamount, $brightness, $saturation, $file_path, $output_path){
        echo('here');
         exec( "bash cartoon.sh -p " . $pattern . " -n " . $numlevels . " -m " . $edgemethod . " -e " . $edgeamount . " -b " . $brightness . " -s " . $saturation . " " . $file_path . " " .  $output_path, $output, $return);
    ...
    cropImage($file_path, $cordinates);
